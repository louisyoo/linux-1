...
#define MESON_I2C_MASTER_A_GPIOB_8_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_A_GPIOB_8_BIT      (1<<16)
#define MESON_I2C_MASTER_A_GPIOB_7_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_5)
#define MESON_I2C_MASTER_A_GPIOB_7_BIT      (1<<17)

#define MESON_I2C_MASTER_A_GPIOX_28_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_A_GPIOX_28_BIT     (1<<14)
#define MESON_I2C_MASTER_A_GPIOX_27_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_A_GPIOX_27_BIT     (1<<17)
...
#define MESON_I2C_MASTER_B_GPIOB_3_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_B_GPIOB_3_BIT      (1<<16)
#define MESON_I2C_MASTER_B_GPIOB_2_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_B_GPIOB_2_BIT      (1<<17)

#define MESON_I2C_MASTER_B_GPIOX_30_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_B_GPIOX_30_BIT     (1<<10)
#define MESON_I2C_MASTER_B_GPIOX_29_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_1)
#define MESON_I2C_MASTER_B_GPIOX_29_BIT     (1<<12)
...
/*M2 i2c pinmux
 * I/O              I2C_MASTER_A        I2C_MASTER_B        I2C_SLAVE
 * GPIOA_1       SDA_A REG6[3]                                  SDA REG6[1]
 * GPIOA_2       SCK_A REG6[2]                                  SCK REG6[0]
 * GPIOA_4                                  SDA_B REG6[9]       SDA REG6[7]
 * GPIOA_5                                  SCK_B REG6[8]       SCK REG6[6]
 * GPIOB_0       SDA_A REG6[13]                                 SDA REG6[11]
 * GPIOB_1       SCK_A REG6[12]                                 SCK REG6[10]
 * GPIOB_6                                  SDA_B REG6[25]      SDA_A REG6[23]
 * GPIOB_7                                  SCK_B REG5[24]      SCK_A REG6[22]
*/

/*i2c master a*/
#define A3_I2C_MASTER_A_GPIOA_1_REG    CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_A_GPIOA_1_BIT    (1<<3)
#define A3_I2C_MASTER_A_GPIOA_2_REG    CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_A_GPIOA_2_BIT    (1<<2)

#define A3_I2C_MASTER_A_GPIOB_0_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_A_GPIOB_0_BIT     (1<<13)
#define A3_I2C_MASTER_A_GPIOB_1_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_A_GPIOB_1_BIT     (1<<12)

/*i2c master b*/
#define A3_I2C_MASTER_B_GPIOA_4_REG    CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_B_GPIOA_4_BIT    (1<<9)
#define A3_I2C_MASTER_B_GPIOA_5_REG    CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_B_GPIOA_5_BIT    (1<<8)

#define A3_I2C_MASTER_B_GPIOB_6_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_B_GPIOB_6_BIT     (1<<25)
#define A3_I2C_MASTER_B_GPIOB_7_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_MASTER_B_GPIOB_7_BIT     (1<<24)

/*i2c slave*/
#define A3_I2C_SLAVE_GPIOA_1_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOA_1_BIT     (1<<1)
#define A3_I2C_SLAVE_GPIOA_2_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOA_2_BIT     (1<<0)

#define A3_I2C_SLAVE_GPIOA_4_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOA_4_BIT      (1<<7)
#define A3_I2C_SLAVE_GPIOA_5_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOA_5_BIT      (1<<6)

#define A3_I2C_SLAVE_GPIOB_0_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOB_0_BIT      (1<<11)
#define A3_I2C_SLAVE_GPIOB_1_REG      CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOB_1_BIT      (1<<10)

#define A3_I2C_SLAVE_GPIOB_6_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOB_6_BIT     (1<<23)
#define A3_I2C_SLAVE_GPIOB_7_REG     CBUS_REG_ADDR(PERIPHS_PIN_MUX_6)
#define A3_I2C_SLAVE_GPIOB_7_BIT     (1<<22)


/*A3 i2c pinmux
 * I/O              I2C_MASTER_A        I2C_MASTER_B        I2C_SLAVE
 * GPIOX_27         SDA_A REG1[7]                           SDA_A REG1[8]
 * GPIOX_28         SCK_A REG1[4]                           SCK_A REG1[5]
 * GPIOX_29                             SDA_B REG1[12]      SDA_B REG1[13]
 * GPIOX_30                             SCK_B REG1[10]      SCK_B REG1[11]
 * GPIOB_2                              SDA_B REG1[17]      SDA_A REG1[15]
 * GPIOB_3                              SCK_B REG1[16]      SCK_A REG1[14]
 * GPIOB_7          SDA_A REG5[17]                          SDA_A REG5[19]
 * GPIOB_8          SCK_A REG5[16]                          SCK_A REG5[18]
*/
