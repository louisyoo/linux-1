 ...
 * interace for additional info was no new reg was needed in CDU programming
 * model.
 *
 * ------------------
 * MMU v3
 ...
 */
static void __arc_icache_inv_lines_vaddr(unsigned long paddr,
...
{
	__arc_dcache_inv_lines(paddr, vaddr & PAGE_MASK, PAGE_SIZE, 1);
}
